    ...
    $(document).ready(function() {
        ...
        if (typeof twitterFeedUrl !== 'undefined') {
            $.getJSON(twitterFeedUrl, function(data) {
                $.each(data.items, function(i, gist) {
                    var content =  gist.object.content.replace(/rel="nofollow"/g, 'rel="nofollow" target="_blank"');
                    var tweetElement = '<div class="tweet animated fadeInUp hidden"><p class="tweet-text">' + content + '</p><p class="tweet-meta">by <a href="' + gist.actor.url + '" target="_blank">@' + gist.actor.displayName + '</a></p></div>';
